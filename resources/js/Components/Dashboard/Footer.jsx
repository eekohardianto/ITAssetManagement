                ...
                <div className="container-fluid">
                    <div className="row align-items-center justify-content-lg-between">
                        ...
                        <ul className="nav nav-footer justify-content-center justify-content-lg-end">
                            ...
                            <a href="https://sucorinvestam.com" className="nav-link text-muted" target="_blank">Sucor Asset Management</a>
                            </li>
                            <li className="nav-item">
                            <a href="#" className="nav-link text-muted" target="_blank">About Us</a>
                            </li>
                            <li className="nav-item">
                            <a href="https://blog.sucorinvestam.com/" className="nav-link text-muted" target="_blank">Blog</a>
                            </li>
                            <li className="nav-item">
